...
public class M13SwapMethod
{
	 ...
	 * and the second number variable is stored in the first. Displays first and
	 * second number before and after swap Parameter: int num1 is first number, num2
	 * is second number
	 */
	...
	/*
	 * Repeats prompting for integer number until number is positive Assumes only
	 * integer values are entered Does not validate if doubles or non-numeric char
	 * entered Parameter: Scanner input object to read in numbers Return: integer
	 * that is positive number
	 */
	...
	/*
	 * Description: Get sum of numbers from 1 to positiveNumber Parameter: Integer
	 * maxNumber Return: Integer totalSum
	 */
