...
class SimpleGeometricShape
{
	...
	/**
	 * Since filled is boolean, its get method is named isFilled get current filled
	 * value
	 * 
 ...
 * Add comments
 */
class CircleFromSimpleGeometricShape extends SimpleGeometricShape
{
	...
	public CircleFromSimpleGeometricShape(double radius, String color, boolean filled)
	{
		this.radius = radius;
		setColor(color);
		setFilled(filled);
